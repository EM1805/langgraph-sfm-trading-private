...
"""Path-level counterfactual diagnostics facade.

This module owns hypothesis/path reasoning.  It is diagnostic only and must not
be treated as SCM authority.  It reuses the bounded runtime implementation for
compatibility while making the architecture explicit:

    path_parts -> candidate path diagnostics
    scm_parts.scm_counterfactual -> SCM/ID-gated authority
"""

from runtime.cf_types import PathTreatmentSpec
from .path_counterfactual_core import (
